...
val SENTENCE_FORM = "This sentence has A 0's, B 1's, C 2's, D 3's, E 4's, F 5's, G 6's, H 7's, I 8's, and J 9's"
val SENTENCE_BLANKS = ('A' to 'J').map(x => SENTENCE_FORM.split(" ").indexOf(x.toString()))

def extractFromSentence(sentence: String) -> Int[]:
